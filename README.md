...
reliably, and **prove the parse is correct** rather than hoping it is. The lander sheet above is used to organise and format the sheet export of worker totals for the day. It allows me to copy and paste into a shared earnings report in 1 click, without breaking any of the headings or rows logic. Time saver.
